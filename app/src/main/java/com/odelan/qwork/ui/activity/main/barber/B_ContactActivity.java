...
public class B_ContactActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b__contact);
    ...
    @OnClick(R.id.emailTV) public void onEmailClick() {
    ...
    @OnClick(R.id.phoneTV) public void onPhoneClick() {
        Intent intent = new Intent(Intent.ACTION_DIAL);
        intent.setData(Uri.parse("tel:" + MyApplication.SUPPORT_PHONE));
        startActivity(intent);
    }

    @OnClick(R.id.fbIV) public void onFacebookClick() {
        try {
    ...
    @OnClick(R.id.instagramIV) public void onInstagramClick() {
        try {
    ...
    @OnClick(R.id.twtIV) public void onTwitterClick() {
        try {
